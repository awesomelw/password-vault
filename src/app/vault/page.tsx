...
export default function VaultPage() {
  return (
    // Vault dashboard shell before authentication and Firestore data are connected.
        ...
        <div className="grid flex-1 gap-6 py-8 lg:grid-cols-[1fr_18rem]">
          <section>
            ...
            <div className="mt-8 rounded-lg border border-dashed border-zinc-300 bg-white p-8 text-center shadow-sm">
              <h2 className="text-xl font-semibold">No passwords saved yet</h2>
              <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-zinc-600">
                Once Firestore is connected, saved logins will appear here with
                controls to reveal, copy, edit, or delete each record.
              </p>
            </div>
          </section>
          ...
          <aside className="h-fit rounded-lg border border-zinc-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-5 text-sm leading-6 text-zinc-600">
              This page will become the main authenticated workspace after the
              Firebase login flow is added.
            </p>
          </aside>
        </div>
      </section>
